<?php include 'includes/header.php'; ?>
    <div class="container-xxl flex-grow-1 container-p-y bg-gradient">
        <div class="d-flex justify-content-center align-items-center vh-100 logo-wrapper">
            ...
            <div id="title">
                <div class="main-text fw-bold fst-italic">AKURAT</div>
                <div class="secondary-text fst-italic">Administrasi & Keuangan</div>
                <div class="secondary-text fst-italic">Regulasi Dashboard Terpadu</div>
            </div>
        </div>
            <a href="pedoman_dinas.php" class="text-decoration-none text-dark">
                <button class="btn-dashboard" id="btnDashboard">
                    <span class="btn-bg"></span>
                    <span class="btn-text">Lihat Pedoman<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z"/></svg></span>
                </button>
            </a>
    </div>
