          ...
          <div class="card shadow-sm border-0 rounded-3">
            <div class="card-body d-flex justify-content-between align-items-cente">
              <div>
                ...
                <p class="card-text">Klik tombol di samping untuk membuka atau mengunduh file PDF Pedoman Perjalanan Dinas</p>
              </div>
              <div class="text-end">
                <!-- Tombol Buka PDF -->
                <a href="https://drive.google.com/file/d/1TQV-eo9kS8YOuNVgO5oy6EAo4RxISvTM/view?usp=sharing" target="_blank" class="btn btn-primary me-2 mb-2">
                  📄 Buka PDF
                </a>
                <!-- Tombol Download PDF -->
                <a href="https://drive.google.com/uc?export=download&id=1TQV-eo9kS8YOuNVgO5oy6EAo4RxISvTM" class="btn btn-success mb-2">
                  ⬇️ Download PDF
                </a>
              </div>    
            </div>
